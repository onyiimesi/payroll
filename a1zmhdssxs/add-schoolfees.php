<?php include "includes/header.php"; ?>
  ...
  <?php 
   ...
   if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['feesdeduct'])){

      $feesdeduct = $acct->feesDeduct($_POST);
   }
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <form action="" method="post">
                      ...
                      <button type="submit" name="feesdeduct" class="btn btn-primary">Submit</button>
                    </form>
                  </div>
                      ...
                      <table id="example11" class="table table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a onClick="return confirm('Are you sure?')" href="?delfees=<?php echo $results['staff_id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
                          </tr>
                          <?php } } ?>
                        </tbody>
                      </table>
