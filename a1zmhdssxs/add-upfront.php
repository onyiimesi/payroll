<?php include "includes/header.php"; ?>
  ...
  <?php 
   ...
   if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['upfrontdeduct'])){

      $upfrontdeduct = $acct->upfrontDeduct($_POST);
   }
  ...
  <?php 
    ...
    if(isset($_GET['delupfront'])){

      $id = $_GET['delupfront'];
      
      $delpro = $acct->delUpfront($id);
    }
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <form action="" method="post">
                      ...
                      <button type="submit" name="upfrontdeduct" class="btn btn-primary">Submit</button>
                    </form>
                  </div>
                      ...
                      <table class="table table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a onClick="return confirm('Are you sure?')" href="?delupfront=<?php echo $results['staff_id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
                          </tr>
                          <?php } } ?>
                        </tbody>
                      </table>
