<?php include "includes/header.php"; ?>
  ...
  <?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['leaveedit'])){

      $leaveedit = $acct->leaveEdit($_POST, $id);
    }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Leave Bonus</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php 
                  ...
                  $getPro = $acct->getLeaveDeductID($id);
                    if($getPro){
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-10">
                      ...
                      <div>
                        <button type="submit" name="leaveedit" class="btn btn-success">Edit</button>
                      </div>
                    </div>
                  </div>
                </form><hr>
