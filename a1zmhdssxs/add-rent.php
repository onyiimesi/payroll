<?php include "includes/header.php"; ?>
  ...
  <?php 
   ...
   if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['rentdeduct'])){
      ...
      $rentdeduct = $acct->rentDeduct($_POST);
   }
  ...
  <?php 
    ...
    if(isset($_GET['delrent'])){

      $id = $_GET['delrent'];
      
      $delpro = $acct->delRent($id);
    }
                      ...
                      <table id="example11" class="table table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="edit-rent?staffid=<?=$results['staff_id']; ?>" class="btn btn-success">Edit</a>
                                <a onClick="return confirm('Are you sure?')" href="?delrent=<?php echo $results['staff_id']; ?>"><button class="btn btn-danger">Delete</button></a>
                            </td>
                          </tr>
                          <?php } } ?>
                        </tbody>
