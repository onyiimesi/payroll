<?php include "includes/header.php"; ?>
  ...
  <?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['taxedit'])){

      $taxedit = $acct->taxEdit($_POST, $id);
    }
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-10">
                      ...
                      <div>
                        <button type="submit" name="taxedit" class="btn btn-success">Edit</button>
                      </div>
                    </div>
                  </div>
                </form><hr>
